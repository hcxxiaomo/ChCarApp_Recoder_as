...
public class BottomControlPanel extends RelativeLayout implements View.OnClickListener {
	...
	private int DEFALUT_BACKGROUND_COLOR = Color.rgb(46, 46, 84); //Color.rgb(192, 192, 192)
	...
	public void initBottomPanel(){
		if(mMsgBtn != null){
			...
			mMsgBtn.setText(Constant.FRAGMENT_FLAG_MESSAGE);
		}
		if(mContactsBtn != null){
			mContactsBtn.setImage(R.drawable.contacts_unselected);
			mContactsBtn.setText(Constant.FRAGMENT_FLAG_CONTACTS);
		}
		if(mNewsBtn != null){
