...
//		setDefaultFirstFragment(Constant.FRAGMENT_FLAG_PAGE_CAR_CHECK);
	}
	...
	public void onBottomPanelClick(int itemId) {
		...
		Log.i("-xiaomo-", "onBottomPanelClick---->"+tag);
	...
	private void commitTransactions(String tag){
		if (fragmentTransaction != null && !fragmentTransaction.isEmpty()) {
			...
			currFragTag = tag;
			headPanel.setMiddleTitle(tag);//切换标题
			Log.i("-xiaomo-", "commitTransactions---->"+tag);
...
//			Toast.makeText(getApplicationContext(), "tag = " + tag, Toast.LENGTH_SHORT).show();
	...
	private  void switchFragment(String tag){
		Log.i("-xiaomo-", "before:tag="+tag+", currFragTag="+currFragTag);
		...
		Log.i("-xiaomo-", "after:tag="+tag+", currFragTag="+currFragTag);
//		headPanel.setMiddleTitle(tag);//切换标题
	}
